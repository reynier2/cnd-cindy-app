...
# --- 🧠 THE REAL AI BRAIN (Multi-Photo Forced) ---
def analyze_photos_with_ai(photo_paths, zipcode):
    ...
    messages = [
        {
            ...
            Your Task:
            1. You have been provided with MULTIPLE photos. You MUST analyze EVERY SINGLE PHOTO provided. Do not ignore any photo.
            2. Identify ALL visible damage, needed repairs, and renovation opportunities across ALL the photos combined.
            3. Create a single, comprehensive ITEMIZED BID combining all work from all photos, including:
               - Item Name
               - Description of work needed
               - Estimated Material Cost (Zip Code {zipcode})
               - Estimated Labor Cost
               - Total Line Item Cost.
            4. Provide a GRAND TOTAL for the entire combined project.
            5. Add a 'Notes' section for potential hidden issues.
    ...
    prompt_text = f"I have uploaded {len(photo_paths)} photos. Analyze ALL of them and combine into ONE bid. Zip: {zipcode}."
    ...
    for path in photo_paths:
        try:
            ...
            messages[1]["content"].append({"type": "image_url", "image_url": {"url": f"data:image/jpeg;base64,{base64_img}"}})
...
if not stripe_api_key:
    ...
    except: st.error("⚠️ ERROR: Stripe Secret Key not found."); st.stop()
...
if session_id:
    ...
    try:
        ...
        if checkout.payment_status == "paid":
            ...
            else: redeemed.add(session_id); st.session_state.payment_confirmed = True; st.session_state.just_paid = True; del st.query_params["session_id"]; st.rerun()
    ...
    if st.button(T["generate"]):
        with st.spinner(T["spinner"]):
            ...
            try:
                ...
                result_text = analyze_photos_with_ai(saved_paths, "23220")
                ...
                try: clean_pdf_text = clean_pdf_text.encode('latin-1', 'replace').decode('latin-1')
                except: pass
